...
class CodemarkApplicationTests {
    ...
    void testAddRoles() {
        // Add Role "forTestPut"
        ResponseEntity<Role> responseEntity = restTemplate.postForEntity(URL_ROLE,
    ...
    void testPutRole() {
        ...
        ResponseEntity<Role> responseEntity = restTemplate.exchange(URL_ROLE, HttpMethod.PUT,
    ...
    void testAddUsers() {
        ...
        ResponseEntity<User> responseEntity = restTemplate.postForEntity(URL_USER, requestObject,
                User.class);
    ...
    void testGetAllUsers() {
        ResponseEntity<UserDtoForGetAll[]> responseEntity = restTemplate.getForEntity(URL_USER,
